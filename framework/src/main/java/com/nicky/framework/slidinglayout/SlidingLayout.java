package com.nicky.framework.slidinglayout;
...
//                            + delta;
                    ...
                    movement = getMotionEventY(event, mActivePointerId) - mInitialMotionY;
                }else {
                    ...
                    //used for judge which side move to
                    movement = event.getY() - mInitialMotionY;
                }
