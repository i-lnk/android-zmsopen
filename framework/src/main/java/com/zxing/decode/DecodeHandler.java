...
final class DecodeHandler extends Handler {
	...
	private final BaseCaptureAty activity;
	private final MultiFormatReader multiFormatReader;
	private boolean running = true;

	DecodeHandler(BaseCaptureAty activity, Map<DecodeHintType, Object> hints) {
...
//				Message message = Message.obtain(handler, R.id.decode_succeeded, rawResult);
				Message message = Message.obtain(handler, MessageId.decode_succeeded, rawResult);
...
//				Message message = Message.obtain(handler, R.id.decode_failed);
				Message message = Message.obtain(handler, MessageId.decode_failed);
				message.sendToTarget();
			}
		}
	}
