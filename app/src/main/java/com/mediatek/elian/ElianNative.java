...
//			return true;
//		} catch (UnsatisfiedLinkError ule) {
//			System.err.println("WARNING: Could not load elianjni or voiceRecog library!");
//			return false;
//		}
//	}
    ...
    /*
     * PPPPManagementInit SmartConnection
     */
     ...
     */
    public native int StartSmartConnection(String SSID, String Password, String Custom, byte Auth);
