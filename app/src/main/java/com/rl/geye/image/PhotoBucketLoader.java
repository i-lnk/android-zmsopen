 ...
 * 相册目录加载
 */
public class PhotoBucketLoader extends CursorLoader {
    ...
    public PhotoBucketLoader(Context context, boolean showGif) {
        super(context);
    ...
    private PhotoBucketLoader(Context context, Uri uri, String[] projection, String selection,
