...
public class GlUtil {
    ...
    public static void logVersionInfo() {
        Logger.e("vendor  : " + GLES20.glGetString(GLES20.GL_VENDOR));
        Logger.e("renderer: " + GLES20.glGetString(GLES20.GL_RENDERER));
        Logger.e("version : " + GLES20.glGetString(GLES20.GL_VERSION));
